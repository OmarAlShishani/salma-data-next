...
import { IconArchive } from '@tabler/icons-react';import { addRoles, deleteRole, getIntentsPermission } from '@/utils/intentsPermissionUtils';
import { resetIntentsRoles } from '@/redux/features/intentsSlice';
;
        ...
        <div>
            ...
            >
                <Button
                    variant="contained"
                    onClick={async () => {
                        await deleteRole(deleteRoles, intentsId);
                        addRoles(selectedValue, intentsId);
                        resetIntentsRoles();
                        setOpen(false);
                    }}
                >
